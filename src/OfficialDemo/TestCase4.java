...
3. In mobile products list , click on 慉dd To Compare� for 2 mobiles (Sony Xperia & Iphone)
4. Click on 慍OMPARE� button. A popup window opens
...
public class TestCase4 {
	...
	public void setUp() throws Exception {
	  ...
	  public void testTestCase4() throws Exception {
	    ...
	    // 3. In mobile products list , click on 慉dd To Compare� for 2 mobiles (Iphone & Sony Xperia)
