...
2. Click on 慚OBILE� menu
3. In the list of all mobile , click on 慉DD TO CART� for Sony Xperia mobile
4. Change 慟TY� value to 1000 and click 慤PDATE� button. Expected that an error is displayed 
   "The requested quantity for "Sony Xperia" is not available.
5. Verify the error message
6. Then click on 慐MPTY CART� link in the footer of list of all mobiles. A message "SHOPPING CART IS EMPTY" is shown.
...
public class TestCase3 {
	...
	public void setUp() throws Exception {
	  ...
	  public void testTestCase3() throws Exception {
	    ...
	    // 4. Change 慟TY� value to 1000 and click 慤PDATE� button. 
	    ...
	    // 6. Click on 慐MPTY CART� link in the footer of list of all mobiles. A message "SHOPPING CART IS EMPTY" is shown.
